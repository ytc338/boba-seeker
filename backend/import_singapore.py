...
BRANDS = [
    # Tier 1 - Largest presence
    {
        "name": "LiHO Tea",
        "name_zh": "里喝",
        "description": "Homegrown Singapore brand, cheese tea specialty (~85 outlets)",
        "origin_country": "SG",
    },
    {
        "name": "KOI Thé",
        "name_zh": "KOI",
        "description": "Taiwanese classic, balanced sweetness and rich milk tea",
        "origin_country": "TW",
    },
    {
        "name": "Each A Cup",
        "name_zh": "各一杯",
        "description": "Long-standing Singapore favorite",
        "origin_country": "SG",
    },
    {
        "name": "Gong Cha",
        "name_zh": "貢茶",
        "description": "Popular Taiwanese chain, customizable drinks",
        "origin_country": "TW",
    },
    # Tier 2 - Premium/Trending
    {
        ...
        "name_zh": "吃茶三千",
        "description": "Award-winning Dong Ding Oolong milk tea",
        "origin_country": "TW",
    },
    {
        "name": "HEYTEA",
        "name_zh": "喜茶",
        "description": "Chinese brand, iconic cheese tea and premium fruit drinks",
        "origin_country": "CN",
    },
    {
        "name": "Tiger Sugar",
        "name_zh": "老虎堂",
        "description": "Famous tiger stripe brown sugar boba milk",
        "origin_country": "TW",
    },
    {
        "name": "Xing Fu Tang",
        "name_zh": "幸福堂",
        "description": "Brown sugar boba specialist",
        "origin_country": "TW",
    },
    {
        "name": "The Alley",
        "name_zh": "鹿角巷",
        "description": "Deerioca tapioca pearls specialty",
        "origin_country": "TW",
    },
    {
        "name": "Nayuki",
        "name_zh": "奈雪的茶",
        "description": "Premium fresh fruit teas",
        "origin_country": "CN",
    },
    {
        "name": "Chagee",
        "name_zh": "霸王茶姬",
        "description": "Fast-growing Chinese tea chain",
        "origin_country": "CN",
    },
    # Tier 3 - Other notable brands
    {
        "name": "R&B Tea",
        "name_zh": "R&B巡茶",
        "description": "Brown Sugar Boba Milk with Cheese Brûlée",
        "origin_country": "TW",
    },
    {
        "name": "Hollin",
        "name_zh": "賀凜",
        "description": "Flavored pearls specialty (taro, matcha, etc.)",
        "origin_country": "TW",
    },
    {
        "name": "iTEA",
        "name_zh": "iTEA",
        "description": "Budget-friendly bubble tea",
        "origin_country": "SG",
    },
    {
        "name": "Milksha",
    ...
    },
    {
        "name": "Sharetea",
        "name_zh": "歇腳亭",
        "description": "Classic Taiwanese bubble tea chain",
        "origin_country": "TW",
    },
    {
        "name": "PlayMade",
        "name_zh": "PlayMade",
        "description": "Handcrafted pearls, high customization",
        "origin_country": "TW",
    },
    {
        "name": "KEBUKE",
        "name_zh": "可不可",
        "description": "Premium aged black tea, fruit tea series",
        "origin_country": "TW",
    },
    {
        "name": "Yi Fang",
        "name_zh": "一芳",
        "description": "Traditional Taiwan fruit teas",
        "origin_country": "TW",
    },
    {
        "name": "Bober Tea",
        "name_zh": "Bober Tea",
        "description": "Brown sugar crème brûlée specialty",
        "origin_country": "SG",
    },
    {
        "name": "The Whale Tea",
        "name_zh": "大鯨魚",
        "description": "Honey series, collagen series, whale crystals",
        "origin_country": "SG",
    },
]
    ...
    try:
        ...
        for shop in sg_shops:
            ...
            if shop.google_place_id:
                existing = (
                    target_db.query(Shop)
                    .filter(Shop.google_place_id == shop.google_place_id)
                    .first()
                )
                if existing:
                    shops_skipped += 1
...
async def main():
    parser = argparse.ArgumentParser(
        description="Import Singapore boba shops from Google Places API"
    )
    parser.add_argument(

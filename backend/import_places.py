...
BRANDS = [
    ...
    },
    {
        "name": "CoCo都可",
        "name_zh": "CoCo都可",
        "description": "International chain with 5000+ global locations",
        "origin_country": "TW",
    ...
    },
    {
        "name": "麻古茶坊",
        "name_zh": "麻古茶坊",
        "description": "Fruit tea specialty, #3 market share",
        "origin_country": "TW",
    },
    {
        "name": "迷客夏",
    ...
    },
    {
        "name": "茶的魔手",
        "name_zh": "茶的魔手",
        "description": "South Taiwan champion, 500+ stores",
        "origin_country": "TW",
    },
    {
        "name": "得正",
        "name_zh": "得正",
        "description": "Oolong tea specialist, #4 by sales",
        "origin_country": "TW",
    },
    {
        "name": "可不可熟成紅茶",
    ...
    },
    {
        "name": "一沐日",
        "name_zh": "一沐日",
        "description": "Rising Gen-Z favorite, mochi toppings",
        "origin_country": "TW",
    },
    {
        "name": "龜記",
    ...
    },
    {
        "name": "八曜和茶",
        "name_zh": "八曜和茶",
        "description": "High social buzz ranking",
        "origin_country": "TW",
    },
    {
        "name": "五桐號",
    ...
    for city in cities:
        ...
        try:
            shops_data, _ = await service.text_search(
                query=query, region=city_info["region"], location=city_info["location"]
            )
...
async def main():
    parser = argparse.ArgumentParser(
        description="Import Taiwan boba shops from Google Places API"
    )
    parser.add_argument(
        "--dry-run", action="store_true", help="Don't write to database"
    )
    parser.add_argument(
        "--clear", action="store_true", help="Clear existing shop data before import"
    )
    parser.add_argument(
        "--brands",
        type=str,
        help="Comma-separated brand names to import (default: all)",
    )
    parser.add_argument(
        "--cities", type=str, help="Comma-separated cities to search (default: all)"
    )
